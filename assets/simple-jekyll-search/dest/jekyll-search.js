! function e(t, n, r) {
    ...
    4: [
        function(require, module, exports) {
            ...
            function setOptions(_opt) {
                opt = _opt || {}, opt.fuzzy = _opt.fuzzy || !1, opt.limit = _opt.limit || 10, opt.searchStrategy = require("./SearchStrategies/"+_opt.strategy);
            }
            ...
            var opt = {};
            opt.limit = 10;
            opt.searchStrategy = require("./SearchStrategies/word");
            module.exports = {
                search: search,
    ...
    8: [
        function(require, module, exports) {
            function WordSearchStrategy() {
              // Matches completed words only

                this.matches = function(string, crit) {
                    var regex = new RegExp("\\b"+crit.toLowerCase()+"\\b");
                    return "string" != typeof string ? !1 : (string = string.trim(), string.toLowerCase().match(regex) !== null);
                }
            }
            module.exports = new WordSearchStrategy();
        }, {}
    ]
}, {}, [7]);
